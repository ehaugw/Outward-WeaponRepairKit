...
* Download "WeaponRepairKit.zip".
* Move "WeaponRepairKit.zip" into the "Outward" game folder.
* Right click "WeaponRepairKit.zip" and click "Extract Here".
...
* Version 1.0.0 and onwards
  ...
  * Delete the "WeaponRepairKit" folder.
